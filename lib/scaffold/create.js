...
var BASE_PACKAGE = {
  description: 'A full Candy node build with Bitcore',
  repository: 'https://github.com/user/project',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-candy': 'git+https://git@github.com/bitcandy/bitcore-lib-candy',
    'bitcore-node-candy': 'git+https://git@github.com/bitcandy/bitcore-node-candy'
  }
};
